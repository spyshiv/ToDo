...
function TodoCtrl($scope) {        
        $scope.todos = [
          {title:'Learn AngularJS', description: 'Learn Learn', timeline: '23/5/2016', completed: 'To do' },         
          {title:'Learn Jquery', description: 'Learn Learn', timeline: '23/5/2016', completed: 'To do'},         
        ];
